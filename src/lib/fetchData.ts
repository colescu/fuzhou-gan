...
async function fetchDictionary() {
  try {
    const response = await fetch(
      "https://raw.githubusercontent.com/colescu/fuzhou-gan-backend/refs/heads/main/data/dictionary.csv"
    );
...
async function fetchVariantsMap() {
  try {
    const response = await fetch(
      "https://raw.githubusercontent.com/colescu/fuzhou-gan-backend/refs/heads/main/data/variants.csv"
    );
